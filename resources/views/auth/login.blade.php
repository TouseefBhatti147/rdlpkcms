...
<html lang="en">
    ...
    <head>
        ...
        <link rel="shortcut icon" href="{{ asset('images/logo5.gif') }}" /> </head>
    <!-- END HEAD -->
    ...
    <body class="login">
        ...
        <div class="logo">
            <a href="/user/home">
                <img src="{{ asset('images/logo5.gif') }}" alt="Logo" /> </a>
        </div>
        <!-- END LOGO -->
        ...
        <div class="content">
           ...
           @include('inc.messages')
            ...
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <h3 class="form-title">User account</h3>
                 ...
                 <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                    ...
                    <div class="input-icon">
                        <i class="fa fa-user"></i>
                            <input id="email" type="email" class="form-control placeholder-no-fix" placeholder="Enter Email" name="email" value="{{ old('email') }}" required autofocus>
                         </div>
                ...
                <!-- Password Modifications start here -->
                    ...
                    <div class="input-icon">
                        <i class="fa fa-lock"></i>
                          <input id="password" type="password" class="form-control placeholder-no-fix" autocomplete="off" placeholder="Enter Password" name="password" required>
                     </div>
