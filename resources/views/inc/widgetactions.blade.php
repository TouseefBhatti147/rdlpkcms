<a
href="{{url('/admin/widgets/update/'.$id)}}"
data-toggle="tooltip"
data-id="{{ $id }}"
...
<div class="col-md-2">
        <button class="btn red btn-sm delete" id="delete-widgets" data-dismiss="modal" data-toggle="tooltip" data-original-title="Delete" data-id="{{ $id }}">Yes Delete !!</button>
</div>
  <div class="col-md-2">
