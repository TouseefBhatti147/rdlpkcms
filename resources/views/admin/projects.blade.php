            ...
            <div class="portlet-body">
              ...
              <div class="table-toolbar">
                  <div class="row">
                      <div class="col-md-6">
                          <div class="btn-group">
                            <a href="{{url('admin/projects/create')}}">  <button id="sample_editable_1_new" class="btn btn-sm red btn-circle form-control"> Add New
...
var SITEURL = '{{URL::to('')}}';
    ...
    $('body').on('click', '#delete-projects', function () {
            ...
            $.ajax({
                type: "delete",
                url: SITEURL + "/admin/projects/delete/"+id,
...
<div>
<!--Add new starts here -->
<a href="{{url('/admin/projects/create')}}" class="btn btn-md green"> Add New &nbsp;<i class="fa fa-plus"></i></a>
<!-- Add new ends here -->
<div class="table-group-actions pull-right">
  <form method="get" action="{{url('/admin/projects/search')}}">
{!! Form::text("searchproject",isset($ProjectEdit)?$ProjectEdit->searchproject:null,["class"=>"form-control input-inline input-small".($errors->has('searchproject')?" is-invalid":"")
                                                  ,"autofocus"
  ...
  <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-settings font-dark"></i><span class="caption-subject font-dark sbold uppercase">Manage Projects</span></div>
            </div>
            <div class="portlet-body">
                                                           ...
                                                           <tr>
                                                             <td>
                                                               <div class="table-title">
                                                                   <div class="title caption-desc font-grey-cascade">{{$Project->title}}</div>
                                                               </div>
                                                             </td>
                                                             <td>
                                                               <div class="table-title">
                                                                   <div class="title caption-desc font-grey-cascade">@if ($Project->status == 1)
                                                                         Enabled
                                                                         @else Disabled
                                                                      @endif</div>
                                                               </div>
                                                             ...
                                                             <td>
                                                               <div class="table-title">
                                                                     <img height="100px" style="object-fit: cover;" width="100px" src="{{ asset('/uploads/'.$Project->image)}}"</img>
                                                               </div>
                                                             </td>
                                                             <td>
                                                               <div class="actions">
                                                                 ...
                                                                 <div class="grid-container">
                                                                        <div class="grid-item">
                                                                          <table>
                                                                            <thead>
                                                               <a href="{{url('/admin/projects/update/'.$Project->id)}}" class="btn blue btn-md">
                                                                    <span class="glyphicon glyphicon-edit">&nbsp;Edit</span>
                                                                 </a>
                                                               </thead>
                                                               <thead>
                                                                 <button type="button" class="btn btn-danger btn-md" data-toggle="modal" href="#basic" data-target="#basic{{$Project->id}}">
                                                                 <span class="glyphicon glyphicon-remove-circle">&nbsp;Delete</span>
                                                                     ...
                                                                     <div class="modal fade" id="basic{{$Project->id}}" tabindex="-1" role="basic" aria-hidden="true" style="display: none;">
                                                                                 ...
                                                                                 <div class="modal-footer">
                                                                                   <div class="grid-container">
                                                                                    ...
                                                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                                                                      ...
                                                                                      <thead>
                                                                                     {!! Form::open(['action' => ['projectsController@delete', $Project->id], 'method' => 'POST']) !!}
