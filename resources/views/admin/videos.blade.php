  ...
  <div class="portlet light bordered">
        <div class="portlet-title">
                  <div class="caption font-dark">
                      ...
                      <span class="caption-subject bold uppercase"> Manage Videos</span>
                  </div>
            </div>
            <div class="portlet-body">
              ...
              <div class="table-toolbar">
                  <div class="row">
                      <div class="col-md-6">
                          <div class="btn-group">
                            <a href="{{url('admin/videos/create')}}">  <button id="sample_editable_1_new" class="btn btn-sm red btn-circle form-control"> Add New
              ...
              <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer" id="datatable">
                  <thead>
                      <tr>
                          ...
                          <th class="sorting_asc" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-sort="ascending" aria-label=" Username : activate to sort column descending" style="width: 80px;">Video</th>
...
var SITEURL = '{{URL::to('')}}';
    ...
    $('body').on('click', '#delete-videos', function () {
            var id = $(this).data("id");
            console.log(id);
            $.ajax({
                type: "delete",
                url: SITEURL + "/admin/videos/delete/"+id,
...
<div>
<!--Add new starts here -->
<a href="{{url('/admin/videos/create')}}" class="btn btn-md green"> Add New &nbsp;<i class="fa fa-plus"></i></a>
<!-- Add new ends here -->
<div class="table-group-actions pull-right">
  <form method="get" action="{{url('/admin/videos/search')}}">
{!! Form::text("searchvideo",isset($VideoEdit)?$VideoEdit->searchsetting:null,["class"=>"form-control input-inline input-small".($errors->has('searchvideo')?" is-invalid":"")
                                                  ,"autofocus"
  ...
  <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-settings font-dark"></i><span class="caption-subject font-dark sbold uppercase">Manage Videos</span></div>
            </div>
            <div class="portlet-body">
                   ...
                   <table class="table table-striped table-bordered table-hover">
                             <thead>
                              <tr>
                                 ...
                                 <th><div class="table-title">Video</div></th>
                               ...
                               <tr>
                                 <td>
                                   <div class="table-title">
                                       <div class="title caption-desc font-grey-cascade">{{$Video->title}}</div>
                                   </div>
                                 </td>
                                 <td>
                                   <div class="table-title">
                                       <div class="title caption-desc font-grey-cascade">    @if ($Video->status == 1)
                                             Enabled
                                             @else Disabled
                                          @endif</div>
                                   </div>
                                 ...
                                 <td>
                                   <div class="table-title">
                                       <iframe style="object-fit: cover;" src="https://www.youtube.com/embed/{{$Video->alias}}" height="150px" width="250px" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                                   </div>
                                 </td>
                                 <td>
                                   <div class="actions">
                                     ...
                                     <a href="{{url('/admin/videos/update/'.$Video->id)}}" class="btn blue btn-md">
                                        <span class="glyphicon glyphicon-edit">&nbsp;Edit</span>
                                     </a>
                                   </thead>
                                         <thead>
                                     <button type="button" class="btn btn-danger btn-md " data-toggle="modal" href="#basic" data-target="#basic{{$Video->id}}">
                                     <span class="glyphicon glyphicon-remove-circle">&nbsp;Delete</span>
                                         ...
                                         <div class="modal fade" id="basic{{$Video->id}}" tabindex="-1" role="basic" aria-hidden="true" style="display: none;">
                                                     ...
                                                     <div class="modal-footer">
                                                       <div class="grid-container">
                                                        ...
                                                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                                          ...
                                                          <thead>
                                                         {!! Form::open(['action' => ['videosController@delete', $Video->id], 'method' => 'POST']) !!}
