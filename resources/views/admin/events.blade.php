  ...
  <div class="portlet light bordered">
        <div class="portlet-title">
                  <div class="caption font-dark">
                      ...
                      <span class="caption-subject bold uppercase"> Manage Events</span>
                  </div>
            </div>
            <div class="portlet-body">
              ...
              <div class="table-toolbar">
                  <div class="row">
                      <div class="col-md-6">
                          <div class="btn-group">
                            <a href="{{url('admin/events/create')}}">  <button id="sample_editable_1_new" class="btn btn-sm red btn-circle form-control"> Add New
...
var SITEURL = '{{URL::to('')}}';
    ...
    $('body').on('click', '#delete-events', function () {
            ...
            $.ajax({
                type: "delete",
                url: SITEURL + "/admin/events/delete/"+id,
...
<div>
<!--Add new starts here -->
<a href="{{url('/admin/events/create')}}" class="btn btn-md green"> Add New &nbsp;<i class="fa fa-plus"></i></a>
<!-- Add new ends here -->
<div class="table-group-actions pull-right">
<form method="get" action="{{url('/admin/events/search')}}">
    {!! csrf_field() !!}
{!! Form::text("searchevent",isset($EventEdit)?$EventEdit->searchevent:null,["class"=>"form-control input-inline input-small".($errors->has('searchevent')?" is-invalid":"")
                                                  ,"autofocus"
  ...
  <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-settings font-dark"></i><span class="caption-subject font-dark sbold uppercase">Manage Events</span></div>
            </div>
            <div class="portlet-body">
                                    ...
                                    <tr>
                                      <td>
                                        <div class="table-title">
                                            <div class="title caption-desc font-grey-cascade">{{$Event->title}}</div>
                                        </div>
                                      </td>
                                      <td>
                                        <div class="table-title">
                                      ...
                                      <td>
                                        <div class="table-title">
                                              <img height="100px" width="100px" src="{{ asset('/uploads/'.$Event->image)}}"></img>
                                        </div>
                                      </td>
                                          ...
                                          <br/>
                                            ...
                                            <div class="grid-container">
                                                   <div class="grid-item">
                                                     <table >
                                                       <thead>
                                          <a href="{{url('/admin/events/update/'.$Event->id)}}" class="btn blue btn-md">
                                             <span class="glyphicon glyphicon-edit">&nbsp;Edit</span>
                                          </a>
                                        </thead>
                                         <thead>
                                          <button type="button" class="btn btn-danger btn-md" data-toggle="modal" href="#basic" data-target="#basic{{$Event->id}}">
                                          <span class="glyphicon glyphicon-remove-circle">&nbsp;Delete</span>
                                              ...
                                              <div class="modal fade" id="basic{{$Event->id}}" tabindex="-1" role="basic" aria-hidden="true" style="display: none;">
                                                          ...
                                                          <div class="modal-footer">
                                                            <div class="grid-container">
                                                             ...
                                                             <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                                               ...
                                                               <thead>
                                                              {!! Form::open(['action' => ['eventsController@delete', $Event->id], 'method' => 'POST']) !!}
