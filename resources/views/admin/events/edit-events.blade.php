...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li><a href="#">{{isset($eventsEdit) ? 'Edit' : 'New'}} Project</a></li>
</ul>
<!-- END PAGE BREADCRUMB -->
...
<div class="portlet light bordered">
    ...
    <div class="portlet-body form">
        ...
        @if(isset($eventsEdit))
        <form method="POST" action="{{ route('events.update', $eventsEdit->id) }}" class="form-horizontal"
                    ...
                    <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-6">
                            <input id="title" type="text" class="form-control @error('title') is-invalid @enderror"
                                name="title" value="{{ old('title', isset($eventsEdit) ? $eventsEdit->title : '') }}"
                    ...
                    <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-6">
                            <input id="alias" type="text" class="form-control @error('alias') is-invalid @enderror"
                                name="alias" value="{{ old('alias', isset($eventsEdit) ? $eventsEdit->alias : '') }}"
                                autofocus placeholder="Enter Alias here" required
                                {{ isset($eventsEdit) ? 'readonly' : '' }}>
                            @error('alias')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                            ...
                            <div class="mt-radio-inline">
                                <label class="mt-radio">
                                    <input type="radio" name="status" value="1"
                                        {{ old('status', isset($eventsEdit) && $eventsEdit->status == 1 ? 'checked' : '') }}>
                                    Enable <span></span>
                                </label>
                                <label class="mt-radio">
                                    <input type="radio" name="status" value="0"
                                        {{ old('status', isset($eventsEdit) && $eventsEdit->status == 0 ? 'checked' : '') }}>
                                    Disable <span></span>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-6">
                            <input id="short_description" type="text"
                                ...
                                value="{{ isset($eventsEdit) ? $eventsEdit->short_description : old('short_description') }}"
