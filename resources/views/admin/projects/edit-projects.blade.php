...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li><a href="{{url('/admin/projects')}}">Manage Projects</a> <i class="fa fa-circle"></i></li>
                    ...
                    <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-6">
                            <input id="title" type="text" class="form-control @error('title') is-invalid @enderror"
                                name="title" value="{{ old('title', isset($ProjectEdit) ? $ProjectEdit->title : '') }}"
                    ...
                    <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-6">
                            <input id="alias" type="text" class="form-control @error('alias') is-invalid @enderror"
                                name="alias" value="{{ old('alias', isset($ProjectEdit) ? $ProjectEdit->alias : '') }}"
                            ...
                            <div class="mt-radio-inline">
                                <label class="mt-radio">
                                    <input type="radio" name="status" value="1"
                                        {{ old('status', isset($ProjectEdit) && $ProjectEdit->status == 1 ? 'checked' : '') }}>
                                    Enable <span></span>
                                </label>
                                <label class="mt-radio">
                                    <input type="radio" name="status" value="0"
                                        {{ old('status', isset($ProjectEdit) && $ProjectEdit->status == 0 ? 'checked' : '') }}>
                                    Disable <span></span>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-6">
                            <input id="website" type="text" class="form-control @error('website') is-invalid @enderror"
                                name="website"
                                value="{{ old('website', isset($ProjectEdit) ? $ProjectEdit->website : '') }}" autofocus
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea id="description" class="form-control @error('description') is-invalid @enderror"
                                ...
                                style="resize: none">{{ old('description', isset($ProjectEdit) ? $ProjectEdit->description : '') }}</textarea>
                            <script>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-6">
                                <input id="meta_title" type="text"
                                    ...
                                    value="{{ old('meta_title', isset($ProjectEdit) ? $ProjectEdit->meta_title : '') }}"
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-6">
                                <textarea id="meta_description"
                                    ...
                                    placeholder="Enter Meta Description">{{ old('meta_description', isset($ProjectEdit) ? $ProjectEdit->meta_description : '') }}</textarea>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-6">
                                <textarea id="meta_keywords"
                                    ...
                                    placeholder="Enter Meta Keywords">{{ old('meta_keywords', isset($ProjectEdit) ? $ProjectEdit->meta_keywords : '') }}</textarea>
                                @error('meta_keywords')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
