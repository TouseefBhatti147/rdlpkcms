            ...
            <div class="portlet-body">
              ...
              <div class="table-toolbar">
                  <div class="row">
                      <div class="col-md-6">
                          <div class="btn-group">
                            <a href="{{url('admin/news/create')}}">  <button id="sample_editable_1_new" class="btn btn-sm red btn-circle form-control"> Add New
...
var SITEURL = '{{URL::to('')}}';
    ...
    $('body').on('click', '#delete-news', function () {
            ...
            $.ajax({
                type: "delete",
                url: SITEURL + "/admin/news/delete/"+id,
...
<div>
<!--Add new starts here -->
<a href="{{url('/admin/news/create')}}" class="btn btn-md green"> Add New &nbsp;<i class="fa fa-plus"></i></a>
<!-- Add new ends here -->
<div class="table-group-actions pull-right">
  <form method="get" action="{{url('/admin/news/search')}}">
{!! Form::text("searchnews",isset($NewsEdit)?$NewsEdit->searchwidget:null,["class"=>"form-control input-inline input-small".($errors->has('searchnews')?" is-invalid":"")
                                                  ,"autofocus"
  ...
  <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-settings font-dark"></i><span class="caption-subject font-dark sbold uppercase">Manage News</span></div>
            </div>
            <div class="portlet-body">
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        ...
                                        <div class="actions">
                                          ...
                                          <a href="{{url('/admin/news/update/'.$New->id)}}" class="btn blue btn-md">
                                                          ...
                                                          <div class="modal-footer">
                                                            <div class="grid-container">
                                                             ...
                                                             <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                                               ...
                                                               <thead>
                                                              {!! Form::open(['action' => ['newsController@delete', $New->id], 'method' => 'POST']) !!}
