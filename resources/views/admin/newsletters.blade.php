            ...
            <div class="portlet-body">
              ...
              <div class="table-toolbar">
                  <div class="row">
                      <div class="col-md-6">
                          <div class="btn-group">
                            <a href="{{url('admin/newsletters/create')}}">  <button id="sample_editable_1_new" class="btn btn-sm red btn-circle form-control"> Add New
...
var SITEURL = '{{URL::to('')}}';
    ...
    // Viewing Data in Ajax DataTable
     $(document).ready( function () {
        $('#datatable').DataTable({
            ...
            "fixedColumns": true,
            "ajax": "{{ route('api.newsletters.index') }}",
            "columns": [
    ...
    $('body').on('click', '#delete-newsletters', function () {
            var id = $(this).data("id");
            console.log(id);
            $.ajax({
                type: "delete",
                url: SITEURL + "/admin/newsletters/delete/"+id,
...
<div>
<!--Add new starts here -->
<a href="{{url('/admin/newsletters/create')}}" class="btn btn-md green"> Add New &nbsp;<i class="fa fa-plus"></i></a>
<!-- Add new ends here -->
<div class="table-group-actions pull-right">
  <form method="get" action="{{url('/admin/newsletters/search')}}">
{!! Form::text("searchnewsletter",isset($NewsEdit)?$NewsEdit->searchnewsletter:null,["class"=>"form-control input-inline input-small".($errors->has('searchnews')?" is-invalid":"")
                                                  ,"autofocus"
  ...
  <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-settings font-dark"></i><span class="caption-subject font-dark sbold uppercase">Manage Newsletters</span></div>
            </div>
            <div class="portlet-body">
                                    ...
                                    <tr>
                                      <td>
                                        <div class="table-title">
                                            <div class="title caption-desc font-grey-cascade">{{$New->title}}</div>
                                        </div>
                                      </td>
                                      <td>
                                          <div class="table-title">
                                        <div class="title caption-desc font-grey-cascade">
                                          @if ($New->status == 1)
                                            Enabled
                                            @else Disabled
                                         @endif
                                      ...
                                      <td>
                                          <div class="table-title">
                                                <img height="100px" width="100px" style="object-fit: cover;" src="{{asset('/uploads/'.$New->image)}}"></img>
                                          </div>
                                      ...
                                      <td>
                                        ...
                                        <div class="actions">
                                          ...
                                          <a href="{{url('/admin/newsletters/update/'.$New->id)}}" class="btn blue btn-md">
                                             <span class="glyphicon glyphicon-edit">&nbsp;Edit</span>
                                          </a>
                                          </thead>
                                          <thead>
                                          <button type="button" class="btn btn-danger btn-md" data-toggle="modal" href="#basic" data-target="#basic{{$New->id}}">
                                          <span class="glyphicon glyphicon-remove-circle">&nbsp;Delete</span>
                                              ...
                                              <div class="modal fade" id="basic{{$New->id}}" tabindex="-1" role="basic" aria-hidden="true" style="display: none;">
                                                          ...
                                                          <div class="modal-footer">
                                                            <div class="grid-container">
                                                             ...
                                                             <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                                               ...
                                                               <thead>
                                                              {!! Form::open(['action' => ['newslettersController@delete', $New->id], 'method' => 'POST']) !!}
