                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('admin/settings/edit/'.$project->id) }}" class="btn blue btn-md">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form action="{{ url('admin/settings/delete/'.$project->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
