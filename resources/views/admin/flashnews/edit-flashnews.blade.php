...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li><a href="#">Edit Flash News</a></li>
</ul>
<!-- END PAGE BREADCRUMB -->
<!-- BEGIN FORM -->
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-dark sbold uppercase">Edit Flash News</span>
        </div>
        <div class="actions">
    ...
    <div class="portlet-body form">
        ...
        <form action="{{ route('flashnews.update', $flashNews->id) }}" method="POST" class="form-horizontal"
            ...
            <div class="form-body">
                    ...
                    <div class="form-group @error('title') has-error @enderror">
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="input-inline input-large">
                                <input type="text" name="title" id="title" value="{{ old('title', $flashNews->title) }}"
                        ...
                        <div class="col-md-4 col-lg-4 @error('link') has-error @enderror">
                            <div class="input-inline input-large">
                                <input type="text" name="link" id="link" value="{{ old('link', $flashNews->link) }}"
                                ...
                                <div class="mt-radio-inline">
                                    <label class="mt-radio">
                                        <input type="radio" name="status" value="1"
                                            {{ $flashNews->status == 1 ? 'checked' : '' }}>
                                        Enable <span></span>
                                    </label>
                                    <label class="mt-radio">
                                        <input type="radio" name="status" value="0"
                                            {{ $flashNews->status == 0 ? 'checked' : '' }}>
                                        Disable <span></span>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-lg-4 @error('ordering') has-error @enderror">
                            <div class="input-inline input-large">
                                <input type="number" name="ordering" id="ordering"
                                    value="{{ old('ordering', $flashNews->ordering) }}"
                    ...
                    <div class="form-group @error('description') has-error @enderror">
                        ...
                        <div class="col-md-9">
                            <textarea name="description" id="description" rows="2" cols="88" class="form-control"
                                style="resize:none">{{ old('description', $flashNews->description) }}</textarea>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-4">
                            <div class="input-inline input-large">
                                <div class="input-group input-large date-picker input-daterange"
                                    data-date="{{ old('start_date', $flashNews->start_date) }}"
                                    data-date-format="yyyy-mm-dd">
                                    <input type="text" name="start_date"
                                        value="{{ old('start_date', \Carbon\Carbon::createFromFormat('Y-m-d', $flashNews->start_date)->format('Y-m-d')) }}"
                                        class="form-control">
                                    <span class="input-group-addon"> to </span>
                                    <input type="text" name="end_date"
                                        value="{{ old('end_date', \Carbon\Carbon::createFromFormat('Y-m-d', $flashNews->end_date)->format('Y-m-d')) }}"
                                        class="form-control">
                                </div>
                                <!-- /input-group -->
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <img id="preview"
                                src="{{ asset($flashNews->image ? 'uploads/' . $flashNews->image : 'images/noimage.jpg') }}"
