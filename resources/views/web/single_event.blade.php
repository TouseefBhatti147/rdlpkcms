             ...
             <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                   <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{url('/index/events')}}">Events</a></li>
...
<!-- Events LIST Start from here from here-->
   <div class="news-list">
         <div class="container">
             <div class="row">
              ...
              <div class="col-12 d-flex justify-content-center col-sm-12 justify-content-start col-md-12 justify-content-md-start col-lg-12 justify-content-lg-start newsCol1">
                    <div class="card" style="width: 100%; border:none;">
                        <img id="media-img-shadow" class="card-img-top"  height="auto" src="{{asset('/uploads/'.$events['image'])}}" alt="Card image cap">
                        <div class="card-body">
...
<!-- Events LIST Ends from here from here-->
