...
@section('title')
    @if(isset($widgets['contact-us']) && $widgets['contact-us']['status'] == 1)
             ...
             <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                   <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
                        <li class="breadcrumb-item"><a href="#}">Our Group</a></li>
...
{{-- our groups starts here --}}
@include('inc.ourgroup')
{{-- our groups ends here --}}
