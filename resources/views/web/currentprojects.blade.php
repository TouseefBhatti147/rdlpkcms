            ...
            <div
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Current Projects</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div
                ...
                <div class="card" style="border:none">
                    <a href="{{ url('/current-projects/' . $projects->alias) }}">
                        <img class="card-img-top" height="200px" style="object-fit: cover;"
                            src="{{ asset('/uploads/' . $projects->image) }}" alt="Card image cap">
                    </a>
                    <div class="card-body">
                        <h2 class="card-title">{{ $projects->title }}</h2>
                        <p class="card-text">{!! $projects->short_description !!}</p>
                        <a class="more-link" href="{{ url('/current-projects/' . $projects->alias) }}">Read More
                            &raquo;</a>
                    </div>
                </div>
            </div>
