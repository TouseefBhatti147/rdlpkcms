...
@section('title')
@if(isset($widgets['upcoming-projects']) && $widgets['upcoming-projects']['status'] == 1)
{{$widgets['upcoming-projects']['meta_title']}}
@endif
@endsection

@section('description')
@if(isset($widgets['upcoming-projects']) && $widgets['upcoming-projects']['status'] == 1)
{{$widgets['upcoming-projects']['meta_description']}}
@endif
@endsection

@section('keywords')
@if(isset($widgets['upcoming-projects']) && $widgets['upcoming-projects']['status'] == 1)
{{$widgets['upcoming-projects']['meta_keywords']}}
@endif
@endsection
...
<div class="list">
    <div class="container">
        <div class="row">
            @foreach($allupcomingprojects as $projects)
            <!-- gallary starts here -->
            ...
            <div
                ...
                <div class="card" style=" border:none ">
                    <a href="{{url('/upcoming-projects/'.$projects->alias)}}"> <img class="card-img-top" height="200px"
                            style="object-fit: cover;" src="{{asset('/uploads/'.$projects->image)}}"
                    ...
                    <div class="card-body">
                        ...
                        <a class="more-link" href="{{url('/upcoming-projects/'.$projects->alias)}}">Read More
                            &raquo;</a>
                    </div>
                </div>
            </div>
