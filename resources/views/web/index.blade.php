            ...
            <div class="row projects-column">
                ...
                <div class="mb_parallax_container" id="mb_parallax">
                    <div class="mb_parallax_overlay">
                        <div class="container container-fluid">
                            <div class="row">
                                <div class="col-12 col-md-10 col-lg-10 our-projects-col1 text-center text-md-left">
                                    <h1> OUR PROJECTS </h1>
                                    <div class="rline">
                                ...
                                <div
                                    class="col-12 col-md-2 our-projects-col1 d-none d-lg-block text-center text-md-right">
                                        ...
                                        <div class="mt-element-overlay">
                                            <div class="col-md-12">
                                                <div class="mt-overlay-4">
                                                    <img id="media-img-shadow"
                                                        src="{{ asset('/uploads/' . $proj->image) }}"
                                                        style="object-fit: cover;">
                                                    <div class="mt-overlay">
                                                        <h2></h2>
                                                        <a class="mt-info btn default btn-primary"
                                                            href="{{ $proj->website }}">Learn
                                                            More</a>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="our-partners">
                                <div class="container">
                                    <div class="row">
                                        <div
                                            class="col-12 text-center text-md-left justify-content-sm-center  col-md-6 opcol1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div
                                            class="col-12 d-flex justify-content-center justify-content-md-start col-md-4 opcol2">
                                            <div class="img-border">
                                                <a href="{{url($files['opaa-1']['link'])}}" target="_blank">
                                                    <img class="img-thumbnail" id="media-img-shadow"
                                                        src="{{asset('/uploads/'.$files['opaa-1']['image'])}}"
                                                        alt="OP image 1">
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            class="col-12 d-flex justify-content-center justify-content-md-start col-md-4  opcol3">
                                            <div class="img-border">
                                                <a href="{{url($files['opaa-2']['link'])}}" target="_blank">
                                                    <img class="img-thumbnail" id="media-img-shadow"
                                                        src="{{asset('/uploads/'.$files['opaa-2']['image'])}}"
                                                        alt="OP image 2">
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            class="col-12 d-flex justify-content-center justify-content-md-start   col-md-4  opcol4">
                                            <div class="img-border">
                                                <a href="{{url($files['opaa-3']['link'])}}" target="_blank">
                                                    <img class="img-thumbnail" id="media-img-shadow"
                                                        src="{{asset('/uploads/'.$files['opaa-3']['image'])}}"
                                                        alt="OP image 3">
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="modal-dialog modal-dialog-custom">
                                    <div class="modal-content">
                                        <div class="modal-header modal-header-custom">
                                            ...
                                            <button type="button" class="nf-close" data-dismiss="modal"
                                        ...
                                        <div class="modal-body modal-body-cutom">
                                            ...
                                            <div class="row shadow-2">
                                                <div class="col-xs-12 col-md-12 col-lg-12">
                                                    ...
                                                    {{--  Date ends here --}}
                                                    <h2
                                                        class="h2-custom text-left label-primary f-font-white padding-10 f-font-yellow yellow">
                                                        <i class="fa fa-star fa-spin yellow"></i> {{$fn->title}}
                                                    </h2>
                                                    ...
                                                    <div>
                                                        ...
                                                        <p></p>
                                                        <div> <img
                                                                src="{{asset(($fn->image!=='')?'uploads/'.$fn->image:'')}}"
                                                ...
                                                <div class="col-xs-12 col-md-12 col-lg-12">
                                                    ...
                                                    @if($fn->link!==null)
                                                    <a class="more-link" href="{{($fn->link!=='')?$fn->link:''}}">Learn
                                                        More &raquo;</a>
                                                    @endif
                                                </div>
                                        ...
                                        <div class="modal-footer modal-footer-custom">
                                            <span class="pull-left"> <input class='modal-check' name='modal-check'
                                                    type="checkbox">
                                                Don't show me
                                                again for rest of the day
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
